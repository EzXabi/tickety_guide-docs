...
<Callout type="warning" emoji="⭐">
    **The Custom bot feature is a Premium feature which requires both a Premium & Custom Bot subscription in order to function**.
</Callout>
...
![Discord Developer Portal](/guide/personalizer/discord_dev_dash.png)

Choose a name for your application and agree to the developer terms and conditions before clicking on `Create` to continue.

![Create Application Popup](/guide/personalizer/Name_application_terms.png)
...
![Application General Configuration](/guide/personalizer/discord_app_geninfo.png)
...
![Application Install Configuration](/guide/personalizer/discord_app_installconf.png)
...
![Application Intents Configuration](/guide/personalizer/discord_bot_settings.png)
...
![Dashboard Configuration](/guide/personalizer/tickety_bot_config.png)
...
![Application Token Reset](/guide/personalizer/bot_reset_token.png)
...
![Online Custom Bot](/guide/personalizer/discord_bot_online.png)
